...
describe('SignUp Page', () => {
  ...
  it('should NOT be able to sign up with without name', async () => {
    const { getByPlaceholderText, getByText } = render(<SignUp />);
  ...
  it('should NOT be able to sign up with without email', async () => {
    const { getByPlaceholderText, getByText } = render(<SignUp />);
  ...
  it('should NOT be able to sign up with an invalid email', async () => {
    const { getByPlaceholderText, getByText } = render(<SignUp />);
  ...
  it('should NOT be able to sign up with without password', async () => {
    const { getByPlaceholderText, getByText } = render(<SignUp />);
